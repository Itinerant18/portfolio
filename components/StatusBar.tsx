export default function StatusBar() {
  return (
    <div className="flex h-[22px] w-full items-center justify-between bg-[#0078d4] px-3 text-[12px] text-white font-mono select-none">
      <div className="flex items-center gap-4">
        <span className="cursor-pointer hover:bg-white/20 px-1 rounded transition-colors flex items-center gap-1.5">
        ...
        <span className="cursor-pointer hover:bg-white/20 px-1 rounded transition-colors flex items-center gap-1">
          <svg viewBox="0 0 16 16" fill="currentColor" className="w-3.5 h-3.5">
      ...
      <div className="flex items-center gap-4">
        <span className="cursor-pointer hover:bg-white/20 px-1 rounded transition-colors">Copilot</span>
        <span className="cursor-pointer hover:bg-white/20 px-1 rounded transition-colors">TypeScript</span>
